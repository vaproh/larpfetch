...
| | |
|---|---|
| A cross-platform terminal fetch utility that detects real system information and lets you lie about it. Ships with 533 colored ASCII logos from fastfetch and 13 built-in LARP profiles. | ![There's no limit to the LARP](assets/larp-meme.gif) |
